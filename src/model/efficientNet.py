...
from model.efficientNetDependencies.ops_misc import Conv2dNormActivation, SqueezeExcitation
from model.efficientNetDependencies.tronsforms_presets import ImageClassification, InterpolationMode
from model.efficientNetDependencies.torchVision_utils import _log_api_usage_once
from model.efficientNetDependencies.models_api import register_model, Weights, WeightsEnum
from model.efficientNetDependencies.imageNetCategories import _IMAGENET_CATEGORIES
from model.efficientNetDependencies.model_utils import _make_divisible, _ovewrite_named_param, handle_legacy_interface
