...
class crossAttention(nn.Module):
    ...
    def forward(self,lidar,cam):
        ...
        q = self.Q(lidar.view(25,1024,-1)).view(lidar.shape)
        k = self.K(cam.view(25,1024,-1)).view(cam.shape)
        v = self.V(cam.view(25,1024,-1)).view(cam.shape)
        ...
        out = self.out(out.view(25,1024,-1)).view(out.shape)
