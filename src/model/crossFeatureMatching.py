...
class crossFeatureMatching(nn.Module):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.conv1x1B1 = nn.Conv2d(1024, 512,kernelSize, padding=padding, stride=stride)
        nn.init.xavier_uniform_(self.conv1x1B1.weight)
        self.conv1x1B2 = nn.Conv2d(512, 256,kernelSize, padding=padding, stride=stride)
        nn.init.xavier_uniform_(self.conv1x1B2.weight)
        self.conv1x1B3 = nn.Conv2d(256, 128,kernelSize, padding=padding, stride=stride)
        nn.init.xavier_uniform_(self.conv1x1B3.weight)
        self.conv1x1B4 = nn.Conv2d(128, 64,kernelSize, padding=padding, stride=stride)
