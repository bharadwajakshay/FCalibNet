...
from model.efficientNetDependencies import transform_functional_pil as F_pil, transform_functional_tensor as F_t
from torchvision.transforms._functional_pil import _is_pil_image
